#!/bin/bash
# Hook: Stop
# Joue un son quand Claude a fini de répondre
# Event: Stop
...
AUDIO_FILE="${CLAUDE_PLUGIN_ROOT}/audio/task-complete.wav"
...
if [[ ! -f "$AUDIO_FILE" ]]; then
    # Tenter de créer un fichier son par défaut
